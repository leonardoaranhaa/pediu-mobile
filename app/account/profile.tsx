...
export default function ProfilePage() {
  ...
  return <Page title="Perfil" eyebrow="SUA CONTA">
    <View style={{ backgroundColor: theme.ink, borderRadius: 28, padding: 21, alignItems: "center", gap: 6, shadowColor: theme.ink, shadowOpacity: 0.18, shadowRadius: 18, shadowOffset: { width: 0, height: 8 }, elevation: 4 }}>
      ...
      {customization.mascotEnabled ? <View style={{ width: "100%", alignItems: "center", marginTop: 5 }}><PediuMascot theme={theme} styleId={customization.mascotStyle} reaction="avoid" motionEnabled={customization.motionEnabled} showSpeech speechSide="right" /></View> : null}
    </View>
    <Card>
