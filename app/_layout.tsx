...
export default function RootLayout() {
  ...
  const content = <GestureHandlerRootView style={{ flex: 1 }}><trpc.Provider client={trpcClient} queryClient={queryClient}><QueryClientProvider client={queryClient}><CartProvider><Stack screenOptions={{ headerShown: false }}><Stack.Screen name="(tabs)" /><Stack.Screen name="oauth/callback" /></Stack><StatusBar style="auto" /></CartProvider></QueryClientProvider></trpc.Provider></GestureHandlerRootView>;
